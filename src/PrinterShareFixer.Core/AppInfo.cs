...
public static class AppInfo
{
    ...
    [
        new("1.4.1", "2026-09-25",
        [
            "新增客户端步骤：清理到目标电脑的旧 SMB 连接，并刷新 DNS 与 NetBIOS 名称缓存——专门处理“指定的网络名不再可用（错误 0x00000040）”。",
            "连通性测试增强：net view 失败时直接解释错误码（5/53/64/67/86/1219/1326），64 会提示这就是 0x00000040 及其处理方式。",
            "连通性测试新增“本机到目标电脑的 SMB 连接”检查，便于判断是否存在失效会话或多重连接冲突。",
            "高级选项新增对应开关（默认开启），可用 --opt smb-cache=false 关闭。",
        ]),
        new("1.4.0", "2026-09-25",
        [
            "界面改为左侧导航栏，共三项：修复打印机共享、打印机信息、设置；「设置」固定在最左下方。",
            "新增「打印机信息」页面：显示计算机名、当前用户及账号类型（管理员 / 标准用户、当前是否已提权）、IPv4 地址与网卡（含 MAC、速率）。",
            "新增：列出本机安装的全部打印机，标明哪些已共享、哪些是网络连接，并显示驱动、端口与状态；可一键打开 Windows 的打印机设置。",
            "修复页面保留原有的一键修复与逐项进度；「重新检测」与「打印机信息」共用同一份系统快照，避免重复扫描。",
            "设置页面在原有版本号、更新、更新内容之上，增加「打开日志目录 / 打开备份目录」按钮。",
        ]),
        new("1.3.0", "2026-09-25",
        [
